import {BsBell, BsJournalCheck, BsThreeDots, BsUiRadiosGrid} from "react-icons/bs";
import {
    Avatar,
    Box,
    Circle,
            ...
            <Box bg={useColorModeValue('gray.100', 'gray.900')}>
                <Flex h={20} px={8} w={'full'} alignItems={'center'} justifyContent={'space-between'} boxShadow={'xl'}>
                        ...
                        <Menu>
                            <MenuItemButton>
                                <HStack>
                                    ...
                                    <Text color={'brand.textGray'} fontSize={'l'} textColor={'brand.textGray'}
                                          fontWeight={600}>Category</Text>
                                </HStack>
                    ...
                    <Flex alignItems={'center'}>
                        ...
                        />
                        <Spacer w='calc(10vh)'/>
                        <Icon boxSize={6} color={'brand.textGray'} as={BsJournalCheck}
                              display={{base: 'none', md: 'flex'}}/>
                        <Text pl={'2'} pr={'2'} fontSize={'l'} textColor={'brand.textGray'} fontWeight={600}
                              display={{base: 'none', md: 'flex'}}>Placement
                            Test</Text>
